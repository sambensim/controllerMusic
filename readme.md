...
- **The OP-1** – a computer-keyboard-sized box resembling a normal MIDI keyboard but with lots of extra knobs and buttons and a tiny ==LCD== screen in the top left corner. The OP-1 has lots of fun little features, but that screen is what really makes it fun, the visuals and UI are responsive, colorful, and always playful
