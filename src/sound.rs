    ...
    T: SizedSample + FromSample<f32>,
{
    ...
    let mut next_value = move || {
        ...
        (sample_clock * PITCH * 2.0 * std::f32::consts::PI / sample_rate).sin()
    };
...
pub fn do_sound() {
    let (_host, _input_device, _input_config, output_device, output_config) = set_defaults(false);
    match output_config.sample_format() {
        SampleFormat::I8 => run::<i8>(&output_device, output_config.into()),
        SampleFormat::I16 => run::<i16>(&output_device, output_config.into()),
        SampleFormat::I24 => run::<I24>(&output_device, output_config.into()),
        SampleFormat::I32 => run::<i32>(&output_device, output_config.into()),
        // SampleFormat::I48 => run::<I48>(&device, config.into()),
        SampleFormat::I64 => run::<i64>(&output_device, output_config.into()),
        SampleFormat::U8 => run::<u8>(&output_device, output_config.into()),
        SampleFormat::U16 => run::<u16>(&output_device, output_config.into()),
        // SampleFormat::U24 => run::<U24>(&device, config.into()),
        SampleFormat::U32 => run::<u32>(&output_device, output_config.into()),
        // SampleFormat::U48 => run::<U48>(&device, config.into()),
        SampleFormat::U64 => run::<u64>(&output_device, output_config.into()),
        SampleFormat::F32 => run::<f32>(&output_device, output_config.into()),
        SampleFormat::F64 => run::<f64>(&output_device, output_config.into()),
